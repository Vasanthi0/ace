...
<title>Material Handling Trolley - Two Wheel Brick Shifting Trolley Manufacturer from Coimbatore, tamilnadu</title>
<meta name="description" content="Manufacturer of Material Handling Trolley - Two Wheel Brick Shifting Trolley, Brick Shifting Trolley, Concrete Tilting Trolley and Block Shifting Trolley offered by ace machines, Coimbatore, Tamil Nadu." />
<meta name="keywords" content="Material Handling Trolley, Two Wheel Brick Shifting Trolley, Brick Shifting Trolley, Concrete Tilting Trolley, Block Shifting Trolley, Tilting Trolley" />
<meta charset="UTF-8">
   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-md-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">Block Shifting Construction Trolley</h2>
            <p class="mb-4"> </p>
         ...
         <div class="col-12 col-md-5   mb-5 mb-md-0">
            <div class="without-slide">
              <img class="" id="item" src="./update_images/iloveimg-resized (1)/new-product-500x500 (1).jpg" width="100%">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="./update_images/iloveimg-resized (1)/new-product-500x500 (1).jpg" class=" modal-img">
               <h6>Block Shifting Construction Trolley</h6>
