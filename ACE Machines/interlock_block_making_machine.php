   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-md-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">Interlock Block Making Machine</h2>
            <p class="mb-4"> Fully Automatic Interlocking Block Making Machine Heavy duty machine structure, which is made of high density cast steel, is vibration proof.</p>
            ...
            <table class="table table-bordered">
               ...
               <tbody>
                  ...
                  <tr style="background:#e8e6e6">
                     <td>Block Size</td>
                     <td>10"x6"x5" & 10x8"x5"</td>
                  </tr>
                  <tr style="background:#f5f5f5">
                     <td>Pressing Capacity </td>
                     <td>30 TON</td>
                  </tr>
               </tbody>
            </table>
      ...
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               ...
               <h6>Interlock Block Making Machine</h6>
               <p>₹ 6 Lakhs/ Unit</p>
