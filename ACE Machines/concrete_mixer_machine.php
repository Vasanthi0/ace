...
<title>Concrete Mixer Machine - Mini Portable Concrete Mixer Machine Manufacturer from Coimbatore, tamilnadu</title>
<meta name="description" content="Manufacturer of Concrete Mixer Machine - Mini Portable Concrete Mixer Machine, Mini Concrete Mixer, Cement Concrete Mixer Machine and Hydraulic Concrete Mixer With Power Stearing, Coimbatore, Tamil Nadu." />
<meta name="keywords" content="Concrete Mixer Machine, Mini Portable Concrete Mixer Machine, Mini Concrete Mixer, Cement Concrete Mixer Machine, Hydraulic Concrete Mixer With Power Stearing" />
<meta charset="UTF-8">
				...
				<div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
					<div class="row pt-5 pb-4 my-5">
						...
						<div class="col-md-7  mt-5 mb-md-0">
							<h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">Concrete Mixer Machine</h2>
						...
						<div class="col-md-5 ">
							<img src="images/concrete-mixer.JPG" style="width:100%;height:auto;">
					</div>
					</div>
				</div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="images/concrete-mixer.JPG" class=" modal-img">
               <h6>Concrete Mixer Machine</h6>
