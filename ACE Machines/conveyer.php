...
<title>Belt Conveyor  Roller - Belt Conveyor Idler Roller buyers, suppliers, importers, exporters and manufacturers</title>
<meta name="description" content="Belt Conveyor Idler Roller, Get suppliers, exporters, manufacturers and buyers of Belt Conveyor Idler Roller in India and overseas.>
<META NAME="Keywords" content="Belt Conveyor Idler Roller, Belt Conveyor Idler Roller suppliers, Belt Conveyor Idler Roller export">
<meta charset="UTF-8">
   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-md-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">Roller Belt Conveyor</h2>
            <p class="mb-4">Simply put, roller conveyors are a form of conveyor belt that utilizes rollers - evenly-spaced rotating cylinders - to allow objects to skate across its surface. They move material from one place to another destination, and often leverage gravity or implement small motors to do so</p>
		 ...
		 <div class="col-12 col-md-7">
		 	<table class="table table-bordered">
               ...
               <tbody>
                     ...
                     <tr style="background:#e8e6e6">
								<td>Type of Belt Conveyor</td>
								<td>Roller Belt Conveyor</td>
							</tr>
                     <tr style="background:#f5f5f5">
								<td>Conveyor Type</td>
								<td>Belt</td>
         ...
         <div class="col-12 col-md-5   mb-5 mb-md-0">
            <div class="without-slide">
              <img class="" id="item" src="./update_images/iloveimg-resized%20(1)/belt-conveyor-500x500.jpg" width="100%">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="./update_images/iloveimg-resized (1)/belt-conveyor-500x500.jpg" class=" modal-img">
               <h6>Roller Belt Conveyor</h6>
