   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1"> Automatic Fly ash Brick Making Machine ACE 40 T</h2>
            <p class="mb-4">Offering you a complete choice of products which include Concrete Hollow Block Making Machine.</p>
         ...
         <div class="col-12 col-md-5   mb-5 mb-md-0">
            <div class="slide-container ">
              <img class="slideritem slide-hidden" id="item" src="./update_images/iloveimg-resized (1)/hollow-block-making-machine-500x500.jpg" width="100%">
              <img class="slideritem slide-hidden" src="./update_images/iloveimg-resized (1)/hollow-block-making-machine-500x500 (1).jpg" width="100%">
              <img class="slideritem slide-hidden" src="./update_images/iloveimg-resized (1)/new-product-500x500 (1).jpg" width="100%">
            </div>
         </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="./update_images/iloveimg-resized (1)/hollow-block-making-machine-500x500.jpg" class=" modal-img">
