...
<title>Vibrating Table - Paving Block Vibrating Table Manufacturer from tamilnadu</title>
<meta name="description" content="Manufacturer of Vibrating Table - Paving Block Vibrating Table, Paving Block Making Machine, Concrete Block Vibrating Table and Vibrating Machine Table - ace machines, coimbatore, tamilnadu" />
<meta name="keywords" content="Vibrating Table, Paving Block Vibrating Table, Paving Block Making Machine, Concrete Block Vibrating Table, Vibrating Machine Table, Concrete Table Vibrator" />
<meta charset="UTF-8">
   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-md-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">Vibrating Table</h2>
            <p class="mb-4"> vibrating table is useful in settling, densifying, and compacting dry bulk materials, as well as releasing air bubbles from concrete or other liquid materials. Vibrating tables help to keep container sizes to a minimum and therefore reduces the cost of transport.</p>
            ...
            <table class="table table-bordered">
               ...
               <tbody>
                  <tr style="background:#f5f5f5">
                     <td> Producation Capacity </td>
                     <td>2000 Sqft / Shift</td>
                  </tr>
         ...
         <div class="col-12 col-md-5   mb-5 mb-md-0">
            <div class="without-slide ">
              <img class="" id="item" src="./update_images/iloveimg-resized%20(1)/paver-block-vibrating-table-500x500.jpg" width="100%">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="./update_images/iloveimg-resized (1)/paver-block-vibrating-table-500x500.jpg" class=" modal-img">
               <h6>Vibrating Table</h6>
