   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-md-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">Hydraulic Concrete Block Machine</h2>
            <p class="mb-4"> </p>
         ...
         <div  class="col-12 col-md-7">
            <table class="table table-bordered">
               ...
               <tbody>
                  ...
                  <tr style="background:#f5f5f5">
                     <td>Capacity  </td>
                     <td>    50 to 60 Strokes Per Hour		</td>
                  </tr>

                  <tr style="background:#e8e6e6">
                     <td>Types   </td>
                     <td>   Single/Double/Triple Vibrator </td>
                  </tr>
                  <tr style="background:#f5f5f5">
                  ...
                  <tr style="background:#f5f5f5">
                     <td>Block Size </td>
                     <td>	50 to 60 Strokes/hour<br>
                     200 x 200 x 400 mm (8 inch) 4 blocks / Stroke<br>
                     150 x 200 x 400 mm (6 inch) 5  blocks / Stroke<br>
                     100 x 200 x 400 mm (4 inch) 8 blocks / Stroke</td>
                  </tr>
         ...
         <div class="col-12 col-md-5   mb-5 mb-md-0">
            <div class="without-slide">
              <img class="" id="item" src="images/hollow-block-making-machine-500x500.jpg" width="100%">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="images/hollow-block-making-machine-500x500.jpg" class=" modal-img">
               <h6>Hydraulic Concrete Block Machine</h6>
