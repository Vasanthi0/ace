...
<title>Pan Mixer - Pan Mixer  Manufacturer from Coimbatore, Tamilnadu </title>
<meta name="description" content="Manufacturer of Pan Mixer - Pan Mixer, Hydraulic Pan Mixer 500 Kg, Global Pan Mixer 150 Kg and Concrete Pan Mixer 250 Kg offered by ace machines, Coimbatore, Tamil Nadu." />
<meta name="keywords" content="Pan Mixer, Pan Mixer 350 kG, Hydraulic Pan Mixer 500 Kg, Global Pan Mixer 150 Kg, Concrete Pan Mixer 250 Kg, Global Pan Mixer 500 Kg" />
<meta charset="UTF-8">
				...
				<div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
					<div class="row pt-5 pb-4 my-5">
						...
						<div class="col-md-7  mt-5 mb-md-0">
							<h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">PAN MIXER</h2>
							<p>Pan mixers are specially designed, study in construction and easy to mix Flyash, Lime, Gypsum, Cement, Sand and Coarse aggregates. The concrete mixed in pan mixer improves the quality and strength due to attrition exerted by the pressure of the CI rollers.</p>
							...
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr style="background:#f5f5f5">
										<td>Door open	 </td>
										<td> Manual / Numatic</td>

									</tr>
									<tr style="background:#e8e6e6">
										<td>Avialable Capacity	 </td>
										<td>250kg/300kg/750 kg</td>
						...
						<div class="col-md-5 ">
							<img src="images/pan-mixer.jpg" style="width:100%;height:auto;">
					</div>
					</div>
				</div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="images/pan-mixer.jpg" class=" modal-img">
               <h6>Pan mixers</h6>
