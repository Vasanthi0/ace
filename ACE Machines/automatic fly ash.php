...
<title>Fly Ash Brick Making Machine, Fly Ash Block Making Machine Manufacturer,Supplier</title>
<meta name="description" content="Ace Machine - Manufacturer, Distributor & Supplier of Fly Ash Brick Making Machine Electric Fly Ash Brick Making Machine,Semi-Automatic Fly Ash Brick Making Plant,Automatic Fly Ash Brick Making Machine, India " >
<meta name="keywords" content="Fly Ash Brick Making Machine Manufacturer, Distributor & Supplier, Fly Ash Brick Making Machine, Semi-Automatic Fly Ash Brick Making Plant,Automatic Fly Ash Brick Making Machine, ace machine, Coimbatore, Tamil Nadu, India ">
<meta charset="UTF-8">
			...
			<div role="main" class="main">
				...
				<div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
					<div class="row pt-5 pb-4 my-5">
						...
						<div class="col-md-7  mt-5 mb-md-0">
							<h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">AUTOMATIC FLY ASH BRICK MACHINE  ACE 30T / 40T</h2>
							<p></p>
							...
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr style="background:#e8e6e6" >
										<td>Brick Size	 </td>
										<td>9"x4"x3" / <br> 9”X9”X4”</td>

									</tr>
									<tr style="background:#f5f5f5">
										<td>Frame height</td>
										<td> 1500 mm / 1600 mm</td>
									</tr>
									<tr style="background:#e8e6e6">
						...
						<div class="col-md-5 ">
							<img src="./update_images/iloveimg-resized (1)/40ton-flyash-brick-making-machine-500x500.jpg" style="width:100%;height:auto;">
					</div>
					</div>
				</div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="./update_images/iloveimg-resized (1)/40ton-flyash-brick-making-machine-500x500.jpg" class=" modal-img">
               <h6>Automatic Fly Ash Brick Making Machine ACE 30 T/40 T</h6>
