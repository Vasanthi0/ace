...
<title>Wheel Barrow - Heavy Type Wheel Barrow Manufacturer from Coimbatore, Tamilnadu</title>
<meta name="description" content="Manufacturer of Wheel Barrow - Heavy Type Wheel Barrow, Single Wheel Barrow, W6 Double Wheel Barrow and W7 Single Wheel Barrow offered by ace machines, Coimbatore, Tamil Nadu." />
<meta name="keywords" content="Wheel Barrow, W4 Heavy Type Wheel Barrow, Single Wheel Barrow, W6 Double Wheel Barrow, W7 Single Wheel Barrow, Double Wheel Barrow" />
<meta charset="UTF-8">
   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-md-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">Wheel Barrow Trolley</h2>
            <p class="mb-4">A wheelbarrow is a small hand-propelled vehicle, usually with just one wheel, designed to be pushed and guided by a single person using two handles at the rear, or by a sail to push the ancient wheelbarrow by wind.</p>
         ...
         <div class="col-12 col-md-5   mb-5 mb-md-0">
            <div class="without-slide">
              <img class="" id="item" src="./update_images/iloveimg-resized (1)/wheel-barrow-trolley-500x500.jpg" width="100%">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="./update_images/iloveimg-resized (1)/wheel-barrow-trolley-500x500.jpg" class=" modal-img">
               <h6>Wheel Barrow Trolley</h6>
