   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-md-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">Power Block Making Machine</h2>
            <p class="mb-4">We are a leading Manufacturer of 500 Kg Capacity Pan Concrete Mixer Machine from Coimbatore, India.</p>
         ...
         <div class="col-12 col-md-5   mb-5 mb-md-0">
            <div class="without-slide">
              <img class="" id="item" src="./update_images/iloveimg-resized (1)/pan-mixer-500-kg-capacity-500x500.jpg" width="100%">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="./update_images/iloveimg-resized (1)/pan-mixer-500-kg-capacity-500x500.jpg" class=" modal-img">
