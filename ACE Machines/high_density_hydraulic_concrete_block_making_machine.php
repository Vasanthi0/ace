...
<title>Hydraulic Block Making Machine - Hydraulic Egg Laying Solid Block Making Machine Manufacturer  Coimbatore, Tamilnadu</title>
<meta name="description" content="Manufacturer of Hydraulic Block Making Machine - Hydraulic Egg Laying Solid Block Making Machine, Semi automatic hydraulic block making machine, Hydraulic Solid Block Making Machine and Hydraulic Hollow Block Making Machine offered by Everon Impex, Coimbatore, Tamil Nadu." />
<meta name="keywords" content="Hydraulic Block Making Machine, Hydraulic Egg Laying Solid Block Making Machine, Semi automatic hydraulic block making machine, Hydraulic Solid Block Making Machine, Hydraulic Hollow Block Making Machine, Hydraulic Operated Paving Block Making Machine" />
<meta charset="UTF-8">
   ...
   <div class="container appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
      <div class="row pt-5 pb-4 my-5">
         <div class="col-md-12  mb-5 mb-md-0">
            <h2 class="text-color-dark font-weight-normal text-6 mb-2 pb-1">High Density: Hydraulic Concrete Block Making Machine</h2>
            <p class="mb-4">Providing you the best range of Block Shifting Construction Trolley with effective & timely delivery.Block Shifting Construction Trolley </p>
         ...
         <div  class="col-12 col-md-7">
            <table class="table table-bordered">
               ...
               <tbody>
                  ...
                  <tr style="background:#f5f5f5">
                     <td>Capacity  </td>
                     <td>   80-90 Stokes per hour		</td>
                  </tr>

                  <tr style="background:#e8e6e6">
                     <td>Types   </td>
                     <td> Egg Laying type with Feeder</td>
                  </tr>
                  <tr style="background:#f5f5f5">
                  ...
                  <tr style="background:#e8e6e6">
                     <td>Method	  </td>
                     <td>     Hydarulic / Vibrator	</td>
                  </tr>
                  <tr style="background:#f5f5f5">
                     <td>Block Size </td>
                     <td>	80 to 90 Strokes/hour<br>
                     200 x 200 x 400 mm (8 inch) 8 blocks / Stroke<br>
                     200 x 200 x 400 mm (8 inch) 8 blocks / Stroke<br>
                     200 x 200 x 400 mm (8 inch) 8 blocks / Stroke</td>
                  </tr>
         ...
         <div class="col-12 col-md-5   mb-5 mb-md-0">
            <div class="without-slide">
              <img class="" id="item" src="images/concrete-block-making-machine-500x500.jpg" width="100%">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="modal-dialog" role="document">
      <div class="modal-content adjus-modal-content">
         ...
         <div class="d-flex p-2">
            <div class="w-35">
               <img src="images/concrete-block-making-machine-500x500.jpg" class=" modal-img">
               <h6>High Density: Hydraulic Concrete Block Making Machine</h6>
